    ...
    return (
        <>
            ...
            <Container fluid className='pano'>
                ...
                <Modal
                    className='modal-content-informasi'
                    style={{ width: '30%', position: 'fixed', top: '1%', left: '6%'}}
                    show={showImageInfoModal}
                    onHide={handleToggleImageInfoModal}
                    centered
                    aria-labelledby="contained-modal-title-vcenter"
                >
                    <Modal.Header closeButton style={{backgroundColor: "#fff", borderRadius: "0", margin: "0"}}>
                        {/* <Modal.Title className="contained-modal-title-vcenter" style={{fontSize: '1rem'}}>
                    ...
                    <Modal.Body>
                        ...
                        {panoramaGallery[selectedScene] && (
                            <>
                                <p>Tempat ini merupakan <b>{panoramaGallery[selectedScene].text}</b>.</p>
                                <p>Deskripsi: <br></br> {panoramaGallery[selectedScene].description}</p>
